...
//     EXTI_Mode_Interrupt;//选择EXTI的模式，中断响应/事件响应
...
//     2;//指定NVIC_IRQChannel中指定的IRQ通道的抢占优先级
//     NVIC_InitStruct.NVIC_IRQChannelSubPriority =
//     1;//指定NVIC_IRQChannel中指定的IRQ通道的响应优先级
//     NVIC_Init(&NVIC_InitStruct);
// }

// void EXTI1_IRQHandler(void)//中断函数的格式
// {
//     if (EXTI_GetITStatus(EXTI_Line1) == SET)//判断是否为EXTI14进来，返回值为
//     SET or RESET
//     {
