 ...
 * @LastEditTime: 2024-04-21 18:56:30
...
void I2Cdev_writeBits(uint8_t dev_addr, uint8_t reg_addr, uint8_t bit_n,
                     uint8_t data) {
    uint8_t b;
...
void I2Cdev_readBits(uint8_t dev_addr, uint8_t reg_addr, uint8_t bitn,
                    uint8_t *data) {
