...
{
    while(I2C_GetFlagStatus(I2C1,I2C_FLAG_BUSY)); // NOLINT
    I2C_GenerateSTART(I2C1,ENABLE);//起始信号 // NOLINT
    while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_MODE_SELECT)); // NOLINT
    I2C_Send7bitAddress(I2C1,dev_addr,I2C_Direction_Transmitter);//发送设备地址+写信号 // NOLINT
    while(!I2C_CheckEvent(I2C1,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED));//
    I2C_Cmd(I2C1,ENABLE);
